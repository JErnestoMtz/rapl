...
// Maximum<Sub1<Sum<R1,R2>>,
//Ndarr<_, <<<R1 as Add<R2>>::Output as Sub<B1>>::Output as Sub<B1>>::Output>`
//Ndarr<_, <<<<R1 as Add<R2>>::Output as Sub<B1>>::Output as Max>::Output as Sub<B1>>::Output>
where
    R1: Add<R2>,
    R1: Max<R2>,
